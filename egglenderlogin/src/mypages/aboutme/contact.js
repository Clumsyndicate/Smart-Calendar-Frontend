...
function Contact(props){
    ...
    return (
      ...
      <form className={classes.root} noValidate autoComplete="off">
        ...
        <TextField id="standard-basic" label={(props.contactval==="")?"name/address/id":props.contactval} onChange={handleValueChange} defaultValue={(props.contactval==="")?"name/address/id":props.contactval}/>
      </form>
      </div>
    );
}
