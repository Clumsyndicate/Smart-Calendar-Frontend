...
class EggNavigator extends Component{
    render(){
        return(
            <nav className="navbar navbar-expand-lg navbar-light bg-light">
                ...
                (
                    ...
                    <li className="nav-item dropdown">
                        ...
                        <Link className="dropdown-item" to="/myProfile">myProfile</Link>
...
export default connect(mapStateToProps,{logoutAct})(EggNavigator)