  ...
  if(props.data.length===0){
    return (
      <div>
       ...
       <div>
    <p>No person seems to have classes in common as you so far. Try editing your enroll list in <a href="/setting">Settings page</a> to find studymates! (P.s. adding CS 97 will help you find lots of studymates)</p>
    </div>
